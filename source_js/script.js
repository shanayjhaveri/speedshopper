var init_canvas = function() {
  ...
  brush.fillStyle="#005A31";
  brush.fillRect(0, 0, 600 - 10, 1100 - 10);

  // produce
  brush = canvas.getContext("2d");
  brush.fillStyle="#A8CD1B";
  ...
  // repair
  brush = canvas.getContext("2d");
  brush.fillStyle="#800000";
  brush.fillRect(2500, 0, 300 - 10, 500);

  // garden
  brush = canvas.getContext("2d");
  brush.fillStyle="#800000";
  brush.fillRect(2500, 900, 300 - 10, 500);

  /* top row */

  // infants
  brush = canvas.getContext("2d");
  brush.fillStyle="#C6E2FF";
  brush.fillRect(600, 0, 300 - 10, 200);

  // shoes
  brush = canvas.getContext("2d");
  brush.fillStyle="#0276FD";
